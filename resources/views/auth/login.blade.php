...
<body class="bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20 relative z-10">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-tr from-blue-600 to-indigo-600 text-white font-black text-2xl shadow-xl shadow-blue-500/30 mb-4">
                L
            </div>
        ...
        <form action="{{ route('login') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email', 'admin@latiseducation.com') }}" required 
                           class="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                </div>
            </div>
            ...
            <!-- Submit Button -->
            <button type="submit" 
                    class="w-full py-3.5 px-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold rounded-xl text-sm shadow-lg shadow-blue-600/30 transition-all duration-200 transform hover:-translate-y-0.5 active:translate-y-0 cursor-pointer">
                Masuk ke Aplikasi
            </button>
        </form>

        <!-- Demo Credentials Box -->
        <div class="mt-6 p-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-xs text-slate-600">
            ...
            <p class="text-slate-600">Email: <code class="bg-white px-1.5 py-0.5 rounded border border-slate-200 font-mono text-blue-600">admin@latiseducation.com</code></p>
            <p class="text-slate-600 mt-1">Password: <code class="bg-white px-1.5 py-0.5 rounded border border-slate-200 font-mono text-blue-600">admin123</code></p>
        </div>
    </div>
</body>
</html>
