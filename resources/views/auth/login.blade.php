...
<body class="bg-slate-100 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
        ...
        <div class="mt-6 p-3 bg-slate-50 border border-slate-200 rounded-lg text-xs text-slate-600">
            <p class="font-semibold text-slate-700 mb-1">Akun Demo Pengujian:</p>
            <p>Email: <code class="font-mono text-orange-600 font-semibold">admin@latiseducation.com</code></p>
            <p class="mt-0.5">Password: <code class="font-mono text-orange-600 font-semibold">admin123</code></p>
        </div>
    </div>
</body>
</html>
