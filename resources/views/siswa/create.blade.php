...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl border border-slate-200 overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-slate-200 flex items-center justify-between bg-slate-50">
            <div>
                <h3 class="font-bold text-slate-800 text-base">Formulir Tambah Siswa</h3>
        ...
        <!-- Form Tambah Siswa -->
        <form action="{{ route('siswa.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-4">
            @csrf
            ...
            <div>
                ...
                <div class="flex items-center gap-4">
                    <div id="previewContainer" class="w-14 h-14 rounded-lg bg-slate-100 border border-slate-200 flex items-center justify-center text-slate-400 overflow-hidden flex-shrink-0">
                        <svg id="previewPlaceholder" class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
